import {
  ...
  useScheduleWizard,
} from "@/contexts/ScheduleWizardContext";
    ...
    if (currentStep === 1) {
      ...
      if (subject.length < 10) {
        toast({
          ...
          description:
            "Please enter at least 10 characters in the subject field before proceeding.",
          variant: "destructive",
        });
        return;
      }
    ...
    <div className="page-content-full">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted">
          Set up automated posting across your social media platforms
        </p>
      </div>
      ...
      {currentStep === 2 && (
        <Card className="modern-card mb-8">
          <CardHeader>
            ...
            <p className="text-muted">
              Select the social media platforms where you want to publish your
              content
            </p>
          </CardHeader>
          <CardContent>
