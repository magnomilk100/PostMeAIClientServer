...
import { 
  ...
  CreditCard, Crown, Settings, DollarSign, Activity, PauseCircle, PlayCircle,
  TrendingDown, AlertCircle, CheckSquare, XCircle, RefreshCw, Calendar as CalendarIcon
} from "lucide-react";
                ...
                <CardContent>
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge variant={dashboardData?.pendingPosts > 0 ? 'destructive' : 'default'}>
                        {dashboardData?.pendingPosts > 0 ? 'Action Required' : 'Up to Date'}
                      </Badge>
                    </div>
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                ...
                <CardContent>
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-sm text-gray-600 dark:text-gray-300">
                      <span>AI: {dashboardData?.weeklyPosts?.aiPosts || 0}</span>
                      <span>Manual: {dashboardData?.weeklyPosts?.manualPosts || 0}</span>
                    </div>
                    <Button 
                      size="sm" 
                      className="w-full mt-3"
              ...
              <Card className="modern-card">
                ...
                <CardContent>
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      {dashboardData?.schedulers?.inactive || 0} inactive schedulers
                    </p>
                    <Button 
                      size="sm" 
                      className="w-full mt-3"
                ...
                <CardContent>
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge variant={dashboardData?.credits?.balance > 10 ? 'default' : 'destructive'}>
              ...
              <Card className="modern-card">
                ...
                <CardContent>
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-sm text-gray-600 dark:text-gray-300">
                      <span>Reach: {dashboardData?.performance?.totalReach || 0}</span>
                      <span>Clicks: {dashboardData?.performance?.totalClicks || 0}</span>
                    </div>
                    <Button 
                      size="sm" 
                      className="w-full mt-3"
