...
import { db } from "./db";
import { eq, and, or, desc, gt, sql, lt, inArray } from "drizzle-orm";
...
export interface IStorage {
  ...
  findOrCreateUserByEmail(userData: {
    email: string;
    firstName?: string;
    lastName?: string;
  ...
  getWorkspacesByIds(workspaceIds: number[], organizationId: number): Promise<Workspace[]>;
  ...
  createUserWorkspace(
    userWorkspace: InsertUserWorkspace,
  ...
  getUserWorkspaceRolesByWorkspace(
    workspaceId: number,
  ): Promise<UserWorkspaceRole[]>;
  assignUserWorkspaceRole(
    assignment: InsertUserWorkspaceRole,
  ): Promise<UserWorkspaceRole>;
  removeUserWorkspaceRole(
    userId: string,
    workspaceId: number,
    roleId: number,
  ): Promise<boolean>;
  removeAllUserWorkspaceRoles(
    userId: string,
    workspaceId: number,
  ): Promise<boolean>;
  ...
  createWorkspaceInvitation(
    invitation: InsertWorkspaceInvitation,
  ): Promise<WorkspaceInvitation>;
  getWorkspaceInvitationByKey(
    key: string,
  ...
  createInvitationWorkspaceRoles(
    roles: InsertInvitationWorkspaceRole[],
  ): Promise<void>;
  getUserInvitationsByUserId(
    userId: string,
    organizationId: number,
  ): Promise<UserInvitation[]>;
  getUserInvitationsByEmail(
    email: string,
    organizationId: number,
  ): Promise<UserInvitation[]>;
  getUserInvitationByKey(key: string): Promise<UserInvitation | undefined>;
  getInvitationWorkspaceRoles(
    invitationId: number,
  ): Promise<InvitationWorkspaceRole[]>;
  ...
  createGeneratedContent(
    content: InsertGeneratedContent,
    userId: string,
    workspaceId: number,
  ): Promise<GeneratedContent>;
  getGeneratedContentByPostId(
    postId: number,
    userId: string,
    workspaceId: number,
  ...
  createPublishedPost(
    publishedPost: InsertPublishedPost,
    userId: string,
    workspaceId: number,
  ): Promise<PublishedPost>;
  getPublishedPostsByPostId(
    postId: number,
    userId: string,
    workspaceId: number,
  ): Promise<PublishedPost[]>;
  ...
  upsertSocialMediaConfig(
    config: InsertSocialMediaConfig,
    userId: string,
    workspaceId: number,
  ): Promise<SocialMediaConfig>;
  updateSocialMediaConfigTestStatus(
    userId: string,
    platformId: string,
    status: string,
    workspaceId: number,
  ...
  createPostSchedule(
    schedule: InsertPostSchedule,
    workspaceId: number,
  ): Promise<PostSchedule>;
  getPostSchedulesByUserId(
    userId: string,
    workspaceId: number,
  ): Promise<PostSchedule[]>;
  getPostScheduleById(
    ...
    userId: string,
    workspaceId: number,
  ): Promise<PostSchedule | undefined>;
  updatePostSchedule(
    id: number,
    updates: Partial<PostSchedule>,
    userId: string,
    workspaceId: number,
  ): Promise<PostSchedule | undefined>;
  deletePostSchedule(
  ...
  createScheduleExecution(
    execution: InsertScheduleExecution,
  ): Promise<ScheduleExecution>;
  getScheduleExecutionsByScheduleId(
    scheduleId: number,
    userId: string,
  ): Promise<ScheduleExecution[]>;
  ...
  logConsentDecision(
    auditData: InsertConsentAuditLog,
  ...
  assignRoleToInvitedUser(
    userId: string,
    workspaceId: number,
    roleId: number,
    organizationId: number,
  ): Promise<void>;
  assignUserToAllWorkspaces(
    userId: string,
    organizationId: number,
  ): Promise<void>;

  // Admin user deletion operations
  getUserWorkspacesByOrganization(
    userId: string,
    organizationId: number,
  ): Promise<UserWorkspace[]>;
...
export class DatabaseStorage implements IStorage {
  ...
  async findOrCreateUserByEmail(userData: {
    ...
    if (existingUser) {
      ...
      console.log(
        `Found existing user for email ${userData.email}, updating auth method to ${userData.authProvider}`,
      );
      ...
      console.log(
        `Creating new user for email ${userData.email} with auth provider ${userData.authProvider}`,
      );
  ...
  async updateUserCurrentWorkspace(
    userId: string,
    workspaceId: number,
  ): Promise<void> {
    // Get the workspace to find its organization
  ...
  async createUserOrganization(
    userOrganizationData: InsertUserOrganization,
  ): Promise<UserOrganization> {
  ...
  async getWorkspacesByUserId(userId: string, organizationId?: number): Promise<Workspace[]> {
    ...
    if (organizationId !== undefined) {
      whereConditions.push(eq(workspaces.organizationId, organizationId));
    }
  ...
  async getWorkspaceInvitationByKey(
    key: string,
  ): Promise<WorkspaceInvitation | undefined> {
  ...
  async createGeneratedContent(
    insertContent: InsertGeneratedContent,
    organizationId: number,
    workspaceId: number,
  ): Promise<GeneratedContent> {
  ...
  async getGeneratedContentByPostId(
    postId: number,
    organizationId: number,
    workspaceId: number,
  ): Promise<GeneratedContent | undefined> {
  ...
  async createPublishedPost(
    insertPublishedPost: InsertPublishedPost,
    workspaceId: number,
  ): Promise<PublishedPost> {
  ...
  async deleteTemplate(
    ...
    try {
      await db
        .delete(templates)
        .where(
          and(eq(templates.id, id), eq(templates.workspaceId, workspaceId)),
        );
      return true;
    } catch (error) {
  ...
  async createPaymentTransaction(
    insertTransaction: InsertPaymentTransaction,
  ): Promise<PaymentTransaction> {
  ...
  async createPostSchedule(
    insertSchedule: InsertPostSchedule,
    workspaceId: number,
  ): Promise<PostSchedule> {
  ...
  async getPostSchedulesByUserId(
    userId: string,
    workspaceId: number,
  ): Promise<PostSchedule[]> {
    return await db
  ...
  async createScheduleExecution(
    insertExecution: InsertScheduleExecution,
    organizationId: number,
    workspaceId: number,
  ): Promise<ScheduleExecution> {
  ...
  async getScheduleExecutionsByScheduleId(
    scheduleId: number,
    userId: string,
    organizationId: number,
    workspaceId: number,
  ...
  async deletePublishedPostsByPostId(
    postId: number,
    workspaceId: number,
  ): Promise<boolean> {
    const result = await db
  ...
  async deleteGeneratedContentByPostId(
    postId: number,
    workspaceId: number,
  ): Promise<boolean> {
    const result = await db
  ...
  async deleteSocialMediaConfigs(
    userId: string,
    organizationId: number,
    workspaceId: number,
  ): Promise<boolean> {
  ...
  async saveOnboardingData(userId: string, data: any): Promise<User> {
    ...
    if (data.interestedPlatforms)
      updateData.interestedPlatforms = data.interestedPlatforms;
    ...
    if (data.workspaceName) {
      ...
      const organizationData = {
        ...
        description:
          ...
          "Default organization created during onboarding",
      ...
      const workspaceData = {
        ...
        description:
          ...
          "Default workspace created during onboarding",
  ...
  async createInvitationWorkspaceRoles(
    roles: InsertInvitationWorkspaceRole[],
  ): Promise<void> {
  ...
  async getInvitationWorkspaceRoles(
    invitationId: number,
  ): Promise<InvitationWorkspaceRole[]> {
    return await db
      .select()
  ...
  async getUserInvitationsByUserId(
    userId: string,
    organizationId: number,
  ): Promise<UserInvitation[]> {
  ...
  async getUserInvitationsByEmail(
    email: string,
    organizationId: number,
  ): Promise<UserInvitation[]> {
    const invitations = await db
  ...
  async getPendingApprovalsForAdmin(
    adminId: string,
    organizationId: number,
  ): Promise<UserInvitation[]> {
  ...
  async assignUserToAllWorkspaces(
    userId: string,
    organizationId: number,
  ): Promise<void> {
  ...
  async resendInvitation(
    ...
    console.log(
      `🔄 RESEND INVITATION DEBUG - Starting resend for invitation ID: ${invitationId}, org: ${organizationId}`,
    );

    // First, get the original invitation to copy its details
    const originalInvitation = await this.getInvitationById(
      invitationId,
      organizationId,
    );
    ...
    console.log(
      `🔄 RESEND INVITATION DEBUG - Original invitation found: ${originalInvitation.email}`,
    );
    ...
    console.log(
      `🔄 RESEND INVITATION DEBUG - New invitation created with ID: ${newInvitation.id}`,
    );

    // Copy workspace role assignments from the original invitation
    const originalWorkspaceRoles =
      await this.getInvitationWorkspaceRoles(invitationId);
    console.log(
      `🔄 RESEND INVITATION DEBUG - Found ${originalWorkspaceRoles.length} original workspace roles:`,
      originalWorkspaceRoles,
    );
    ...
    if (originalWorkspaceRoles.length > 0) {
      ...
      console.log(
        `🔄 RESEND INVITATION DEBUG - Creating role assignments:`,
        roleAssignments,
      );
      await this.createInvitationWorkspaceRoles(roleAssignments);
      console.log(
        `🔄 RESEND INVITATION DEBUG - Role assignments created successfully`,
      );
    } else {
      console.log(
        `🔄 RESEND INVITATION DEBUG - No workspace roles found for original invitation`,
      );
    }
  ...
  async cancelInvitation(
    ...
    console.log(
      `🚫 CANCEL INVITATION DEBUG - Starting cancel for invitation ID: ${invitationId}, org: ${organizationId}`,
    );
    ...
    if (canceled) {
      console.log(
        `🚫 CANCEL INVITATION DEBUG - Invitation canceled successfully: ${canceled.email}`,
      );
    } else {
      console.log(
        `🚫 CANCEL INVITATION DEBUG - Invitation not found or could not be canceled`,
      );
    }
  ...
  async getUserWorkspaceRoles(
    userId: string,
    workspaceIdOrOrganizationId: number,
  ): Promise<UserWorkspaceRole[]> {
    ...
    const workspace = await db
      .select()
      .from(workspaces)
      .where(eq(workspaces.id, workspaceIdOrOrganizationId))
      .limit(1);
    ...
    if (workspace.length > 0) {
      ...
      return await db
        ...
        .innerJoin(
          workspaceRoles,
          eq(userWorkspaceRoles.roleId, workspaceRoles.id),
        )
        .where(
          and(
            eq(userWorkspaceRoles.userId, userId),
  ...
  async getUserWorkspaceRolesByWorkspace(
    workspaceId: number,
  ): Promise<UserWorkspaceRole[]> {
    return await db
      .select()
  ...
  async getAllUserWorkspaceRolesForOrganization(
    organizationId: number,
  ): Promise<any[]> {
    return await db
      .select({
  ...
  async removeUserWorkspaceRole(
    ...
    try {
      ...
      console.log("🗑️ Was actually deleted:", wasDeleted);

      return wasDeleted;
    } catch (error) {
      console.error("🗑️ Error in removeUserWorkspaceRole:", error);
      return false;
    }
  }

  async removeAllUserWorkspaceRoles(
    userId: string,
    workspaceId: number,
  ): Promise<boolean> {
    const result = await db
  ...
  async hasWorkspacePermission(
    ...
    const userPermissions = await this.getUserWorkspacePermissions(
      userId,
      workspaceId,
    );
  ...
  // Admin operations for pending invitations and user search
  async getPendingInvitationsWithoutRoles(
    organizationId: number,
  ): Promise<any[]> {
  ...
  async searchUsersInOrganization(
    ...
    try {
      ...
      console.log(
        "🔍 Final results with assignments:",
        usersWithAssignments.length,
      );
  ...
  async getUserWorkspacesByOrganization(
    userId: string,
    organizationId: number,
  ): Promise<UserWorkspace[]> {
    const result = await db
  ...
  async anonymizeUserTransactions(
    userId: string,
    workspaceId: number,
  ): Promise<void> {
    await db
  ...
  async deleteUserWorkspaceRoles(
    userId: string,
    organizationId: number,
  ): Promise<void> {
